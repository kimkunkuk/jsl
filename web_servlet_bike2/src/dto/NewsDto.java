...
public class NewsDto {
	private String no, title, content, attach, reg_id, reg_date, update_date , reg_name;
	private int hit;
	...
	//상세조회용
	public NewsDto(String no, String title, String content, String attach, String reg_date, String update_date, String reg_name,
			int hit) {
		super();
		this.no = no;
		this.title = title;
