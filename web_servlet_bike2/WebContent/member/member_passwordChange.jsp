	...
	function passwordChange(){
		...
		<div id="b_left">
			...
			<ul>
				...
				<li><a href="javascript:goWork('memberJoin')"><span class="fnt"><i class="fas fa-apple-alt"></i></span> Member</a></li>
			</ul>
		</div>
				...
				<div class="member_boxL">
					...
					<div class="login_form">
						<form name="mem">
							...
							<div class="fl_clear"><label for="mbrId" class="pwLabel">현재 비밀번호</label><input name="t_now_pw" id="mbrId" type="text" onkeypress="if( event.keyCode==13 ){goPw()}"></div>
