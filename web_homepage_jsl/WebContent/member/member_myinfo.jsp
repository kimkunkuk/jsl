...
<%@ include file = "../common_header.jsp" %>
 ...
 <body>
	...
	<div class="btnArea Acenter pt60 pb100">
        ...
        <a href="javascript:updateForm();" class="btn_round btn_large btn_pointColor w180"><b>수정</b></a>
        <a href="javascript:deleteForm();" class="btn_round btn_large btn_pointColor w180" style="background: red;"><b>회원탈퇴</b></a>
    </div>
