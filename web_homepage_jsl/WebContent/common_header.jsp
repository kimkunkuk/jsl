			...
			<div class="gnb_group">
				...
				<nav class="gnb">
					<ul class="nav_1depth">
						...
						<li><a href="/web_homepage_jsl/notice/notice.jsp">커뮤니티</a>
							<ul class="nav_2depth">
								<li><a href="/web_homepage_jsl/notice/notice.jsp">공지사항</a></li>
								<li><a href="/web_homepage_jsl/news/news.jsp">뉴스</a></li>
								<li><a href="/web_homepage_jsl/qna/qna_list.jsp">질문과답변</a></li>
								<li><a href="/web_homepage_jsl/faq/faq_list.jsp">FAQ</a></li>
								<li><a href="/web_homepage_jsl/pds/pds.jsp">자료실</a></li>
							<%if(commonsessionLevel.equals("top")) {%>
								<li><a href="/web_homepage_jsl/adm/admin_member_list.jsp">관리자</a></li>
							<%} %>	
							</ul>
						</li>
					</ul>
