...
public class CommonUtil {
	...
	public static String getFile_dir_notice() {
		String noticeDir = "C:/track11_LJH/work_project/web_homepage_jsl/WebContent/attach/notice/"; 
		return noticeDir;
	}
	
	public static String getFile_dir_news() {
		String newsDir = "C:/track11_LJH/work_project/web_homepage_jsl/WebContent/attach/news/"; 
		return newsDir;
	}
	
	public static String getFile_dir_pds() {
		String pdsDir = "C:/track11_LJH/work_project/web_homepage_jsl/WebContent/attach/pds/";
		return pdsDir;
	}
	
	//오늘날짜 static 이라서 new 생성자 만들필요없이 바로 쓸수있음
